    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">{{ $about_data->judul }}</span>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        {!! set_about_nama($about_data->judul) !!}
                    </h1>
                    ...
                    <div class="lead mb-5">{!! $about_data->isi !!}</div>
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <div class="subheading mb-3">{{ $item->item1 }}</div>
                          {!! $item->isi !!}
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">{{ $item->tanggal_mulai_indo }} - {{ $item->tanggal_akhir_indo }}</span></div>
                    </div>
                    @endforeach
                        </section>
            <hr class="m-0" />
            ...
            <section class="resume-section" id="interests">
                <div class="resume-section-content">
                    <h2 class="mb-5">{{ $interest_data->judul }}</h2>
                    {!! $interest_data->isi !!}
            </section>
            <hr class="m-0" />
            <!-- Awards-->
            <section class="resume-section" id="awards">
                <div class="resume-section-content">
                    <h2 class="mb-5">{{ $awards_data->judul }}</h2>
                    {!! set_list_awards($awards_data->isi) !!}
                </div>
            </section>
        </div>
        <!-- Bootstrap core JS-->
